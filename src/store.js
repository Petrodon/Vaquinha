...
export default new Vuex.Store({
    state: {
        ...
        cards: [
            ...
            { id: 0, ve: 30, tdoa: 5, term: 40, tot: 90, por: 33, at: 30, title: 'Palhaços para Ajudar Doentes', desc: '', src: 'https://upload.wikimedia.org/wikipedia/commons/d/d9/Palha%C3%A7os_da_Ong.jpg', plans: [{id: 0, title: 'Standard', desc: 'Sincera gratidão', val: 5}, {id: 1, title: 'Premium', desc: 'Standard + camiseta', val: 15}], tags: { tipo: 'Social', local: 'São Paulo - SP' } },
            { id: 1, ve: 20, tdoa: 12, term: 100, tot: 200, por: 50, at: 100, title: 'Salvando Cachorros', src: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/Sad-pug.jpg', plans: [{id: 0, title: 'Standard', desc: 'Sincera gratidão', val: 5}, {id: 1, title: 'Premium', desc: 'Standard + camiseta', val: 15}], tags: { tipo: 'Animais', local: 'Rio de Janeiro - RJ' } },
